<h2><?php _e( "Setup", "lively-chat-support" ); ?></h2>
<ol>
  <li><?php echo sprintf( __("Set up your agents on the <a href=\"%s\">Agents</a> page."), admin_url("admin.php?page=livelychatsupport&tab=agents") ); ?></li>
  <li><?php echo sprintf( __("Set your office hours on the <a href=\"%s\">Schedule</a> page."), admin_url("admin.php?page=livelychatsupport&tab=schedule") ); ?></li>
  <li><?php echo sprintf( __("Visit the <a href=\"%s\">Settings</a> page to change the appearance of your chat box."), admin_url("admin.php?page=livelychatsupport&tab=settings") ); ?></li>
  <li><?php _e("Chat with your visitors.", "lively-chat-support"); ?></li>
